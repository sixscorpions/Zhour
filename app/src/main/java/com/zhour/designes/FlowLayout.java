...
/**
 * Created by Haseena on 3/30/2017.
 **/
...
public class FlowLayout extends ViewGroup {
    ...
    private void init() {
        paddingHorizontal = getResources().getDimensionPixelSize(R.dimen._10dp);
        paddingVertical = getResources().getDimensionPixelSize(R.dimen._10dp);
    }
