...
public class JSONTask extends AsyncTask<Object, Integer, Object> {
    ...
    protected Object doInBackground(Object... objects) {
        ...
        try {
            ...
            if (!Utility.isValueNullOrEmpty(Utility.getSharedPrefStringData(parent, Constants.TOKEN))) {
                String token = Utility.getSharedPrefStringData(parent, Constants.TOKEN);
